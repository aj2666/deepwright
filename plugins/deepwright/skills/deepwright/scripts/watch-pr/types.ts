...
export interface GitHubMergeRefusal {
  ...
  readonly reason:
    | "exact-head-unproven"
    | "head-rollup-unproven"
    | "merge-state-blocked"
    | "merge-state-unproven";
  readonly exactHead: "observed" | "unproven";
  readonly mergeStateStatus: MergeStateStatus;
...
export type GitHubMergeAllowed =
  | {
      ...
      readonly exactHead: "observed";
      readonly mergeStateStatus: "CLEAN";
      readonly headRollupState: "SUCCESS";
    }
  | {
      readonly kind: "allowed";
      readonly basis: "draft-override";
      readonly exactHead: "observed";
      readonly mergeStateStatus: "DRAFT";
      readonly headRollupState: "SUCCESS";
    };

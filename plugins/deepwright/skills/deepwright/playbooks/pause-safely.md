...
4. Write `.deepwright/runs/<run-slug>/resume.md`. Capture intent, current branch and worktree, progress, verification evidence, pending steps, key files, active PRs, and gotchas. If a `$show-me-your-work` trail exists, link to it instead of duplicating it. Keep secrets and private conversation text out of the note.

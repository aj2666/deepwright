...
- Check for the pattern, not just the reported instance. Fix other occurrences only when they are inside the authorized scope; otherwise report them with evidence.

...
- Set `NOTES_DATA_DIR` to a unique directory under a validated writable `TMPDIR`; if none exists, use `.deepwright/tmp/notes-verify-$RUN_ID`. Do not assume a system temporary root exists.

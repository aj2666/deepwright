...
- Pin checkout, Node setup, and artifact upload actions to Node 24 runtimes, removing GitHub Actions runtime deprecation warnings without changing the tested Node versions.
